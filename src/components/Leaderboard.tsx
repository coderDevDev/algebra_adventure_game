...
export const Leaderboard: React.FC<LeaderboardProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center pointer-events-auto p-4 z-50">
            <div className="bg-white rounded-3xl shadow-lg p-6 w-full max-w-3xl mx-4 max-h-[95vh] overflow-hidden flex flex-col">
                    <button
                        onClick={onClose}
                    ...
                    {playerRank && (
                        <div className="mb-4 p-3 rounded-xl bg-gradient-to-r from-amber-100 to-yellow-100 border-2 border-amber-300">
                    ...
                    <div className="flex space-x-2 mb-4 overflow-x-auto">
                        {[
                            ...
                            <button
                                ...
                                className={`px-3 py-2 rounded-xl transition-all duration-200 font-medium text-xs sm:text-sm ${
                                    ...
                                    <tbody>
                                        {leaderboardData.map((entry, index) => {
                                            ...
                                            return (
                                                <tr
                                                    key={entry.id || index}
                                                    className={`border-b border-gray-200 transition-all duration-200 hover:bg-gray-50 text-xs sm:text-sm ${
                                                        isPlayer
                                                            ? "bg-gradient-to-r from-blue-100 to-indigo-100 font-bold"
                                                            : "bg-white"
                                                    }`}
                                                >
                                                    ...
                                                    <td className="p-2 text-center">
                                                        <span className="inline-block px-2 py-1 bg-amber-100 text-amber-700 rounded-full text-xs font-bold">
                                                            🏆 {entry.badges}
                                                        </span>
                                                    </td>
                                                    {selectedTab ===
