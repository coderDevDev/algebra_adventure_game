...
export const PWAInstallPrompt: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (window.matchMedia("(display-mode: standalone)").matches) {
            setIsInstalled(true);
            console.log("✅ Algebra Adventure is running as installed PWA");
            return;
        }
        ...
        window.addEventListener("appinstalled", () => {
            console.log("✅ Algebra Adventure PWA installed successfully!");
            setIsInstalled(true);
            ...
            <div className="wooden-frame rounded-lg p-4 max-w-xs sm:max-w-sm shadow-2xl">
                ...
                <div className="parchment-bg rounded-md p-4 relative">
                    ...
                    <p className="text-xs text-amber-600 mb-3">
                        Install Algebra Adventure on your device for:
                    </p>
